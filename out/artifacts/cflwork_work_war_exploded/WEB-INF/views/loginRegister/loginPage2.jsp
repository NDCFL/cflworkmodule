    ...
    <div class="sign-wrap">
        ...
        <div class="sign-form sign-scan" id="scan" style="display:none;">
          ...
          <div class="qrcode-box">
            ...
            <p><span>使用 瑞蓝公寓 APP 扫码登录</span><em>扫码帮助</em></p>
        ...
        <div class="sign-form sign-register" id="register" style="display:none;">
            ...
            <form action="/registe/save.json" method="post">
                ...
                <div class="text-tip"><div class="agreement-tip"><label><input type="checkbox" checked="checked" />同意瑞蓝公寓 <a href="https://www.zhipin.com/register/protocol/introduce" target="_blank">用户协议及隐私政策</a></label></div>已有账号 <a href="javascript:;" onclick="login();" class="link-signin">直接登录</a></div>
            </form>
        </div>
        <!--注册成功完善简历-->
        <div class="sign-form sign-welcome">
            <h3 class="title">欢迎来到瑞蓝公寓</h3>
            <div class="welcome-box">
                <div class="welcome-text">
                    <b>快速完善简历</b>
                    <p>做好与Boss对话前的准备吧。</p>
                </div>
                <img src="https://login.zhipin.com//v2/web/geek/images/icon-sign-welcome.png" alt="" />
