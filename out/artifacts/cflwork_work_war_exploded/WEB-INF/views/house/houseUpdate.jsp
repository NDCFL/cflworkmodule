                ...
                <div class="ibox-content">
                    <form method="post" id="form" role="form" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="hotelId" onchange="getCardTitle(this.value);"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="cardTitle" name="cardTitle" required class="form-control"> <span
                                    class="help-block m-b-none" id="card_title"></span>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" required name="area" id="area">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="unitPrice" required id="unitPrice" class="form-control">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="salePrice" required id="salePrice" class="form-control">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="type" name="type" onchange="getInfo(this.value);"
                                        required>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="shopManagerId" onchange="getShopManager(this.value);"
                                        name="shopManagerId" required>
                                </select>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
...
<script>
    $(function () {
        $.post("/house/findHouse/${id}",
            function (data) {
                $("#cardTitle").val(data.cardTitle);
                ...
                hotel.change();
                var shopManager = $("#shopManagerId").select2();
                shopManager.val(data.shopManagerId).trigger("change");
                shopManager.change();
                var shopAgent = $("#shopAgentId").select2();
                shopAgent.val(data.shopAgentId).trigger("change");
                shopAgent.change();
