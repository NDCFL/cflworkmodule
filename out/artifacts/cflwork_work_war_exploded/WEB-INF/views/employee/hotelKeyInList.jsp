            ...
            <form class="form-horizontal" method="post" id="formadd">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">录入员登录账号：</label>
                        <div class="col-sm-8">
                            <input  name="phone" minlength="2" maxlength="20" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">录入员登录密码：</label>
                        <div class="col-sm-8">
...
<script src="<%=path%>/static/js/pageJs/hotelKeyInList.js"></script>
</body>
<script>
    $.post(
        "/house/getHotelList",
