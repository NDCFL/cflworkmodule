            ...
            <form class="form-horizontal" method="post" id="formadd">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input  name="name" minlength="2" id="name" placeholder="商会负责人姓名" maxlength="20" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">联系方式：</label>
                        <div class="col-sm-8">
                            <input  name="phone" minlength="2" id="phone" placeholder="商会负责人联系方式" maxlength="20" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">酒店热线：</label>
                        <div class="col-sm-8">
                            <input  name="tel" minlength="2" id="tel" placeholder="酒店热线" maxlength="20" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">酒店简称：</label>
                        <div class="col-sm-8">
                            <input  name="hotelSinName" id="hotelSinName" minlength="2" placeholder="酒店简称6个字以内" maxlength="20" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">酒店全称：</label>
                        <div class="col-sm-8">
                            <input  name="hotelName" id="hotelName" minlength="2" placeholder="酒店全称" maxlength="20" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">酒店签名：</label>
                        <div class="col-sm-8">
            ...
            <form class="form-horizontal" id="updateform" >
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">姓名：</label>
                        <div class="col-sm-8">
                            <input  name="name" minlength="2" placeholder="商会负责人姓名" maxlength="20" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">联系方式：</label>
                        <div class="col-sm-8">
                            <input  name="phone" minlength="2" placeholder="商会负责人联系方式" maxlength="20" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">酒店热线：</label>
                        <div class="col-sm-8">
                            <input  name="tel" minlength="2" id="tels" placeholder="酒店热线" maxlength="20" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">酒店简称：</label>
                        <div class="col-sm-8">
                            <input  name="hotelSinName" id="hotelSinNames" minlength="2" placeholder="酒店简称6个字以内" maxlength="20" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">酒店全称：</label>
                        <div class="col-sm-8">
                            <input  name="hotelName" minlength="2" maxlength="20" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">酒店签名：</label>
