        ...
        <div class="ibox-content">
            <div class="panel panel-default">
                ...
                <div class="panel-body form-group" style="margin-bottom:0px;">
                    ...
                    <label class="col-sm-1 control-label" style=" margin-top:5px">房型名称</label>
                    <div class="col-sm-2">
                        <select class="form-control" required  id="hotelTypeId_" name="hotelTypeId">
                            <option value="">全部</option>
            ...
            <form class="form-horizontal" method="post" id="formadd">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label" >商会酒店</label>
                        <div class="col-sm-8">
                            <select class="form-control" id="businessManId"  required name="businessManId">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" id="hotelTypeId"  required name="hotelTypeId">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="number" name="price" id="price" class="form-control" required="" aria-required="true"></input>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">库存：</label>
                        <div class="col-sm-8">
                            <input type="number" name="number" id="numbers" class="form-control" required="" aria-required="true"></input>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" id="update_status">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">房型状态：</label>
                        <div class="col-sm-8">
            ...
            <form class="form-horizontal" id="updateform" >
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" >商会酒店</label>
                        <div class="col-sm-8">
                            <select class="form-control" id="businessMan_Id"  required name="businessManId">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" >房型名称</label>
                        <div class="col-sm-8">
                            <select class="form-control" id="hotelType_Id"  required name="hotelTypeId">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">报价：</label>
                        <div class="col-sm-8">
                            <input type="number" name="price" id="prices" class="form-control" required="" aria-required="true"></input>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">库存：</label>
                        <div class="col-sm-8">
                            <input type="number" name="number" id="numberss" class="form-control" required="" aria-required="true"></input>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<script src="<%=path%>/static/js/pageJs/priceItem.js"></script>
</body>
<script>
...
<script>
    $(function () {
        $.post(
            ...
            function (data) {
                $("#businessManId").select2({
                    data: data
                })
                $("#businessMan_Id").select2({
                    data: data
                })
                $("#businessManId_").select2({
                    data: data
                })
                $("#select2-businessManId-container").remove();
                $("#select2-businessMan_Id-container").remove();
                $("#select2-businessManId_-container").remove();
            },
            "json"
        );
        $.post(
            "/hotelType/getHotelTypeList",
            function (data) {
                $("#hotelTypeId").select2({
                    data: data
                })
                $("#hotelType_Id").select2({
                    data: data
                })
                $("#hotelTypeId_").select2({
                    data: data
                })
                $("#select2-hotelTypeId-container").remove();
                $("#select2-hotelType_Id-container").remove();
                $("#select2-hotelTypeId_-container").remove();
            },
            "json"
        );
    });
