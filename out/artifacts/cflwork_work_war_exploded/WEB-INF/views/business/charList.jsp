    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" id="update_status">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">论坛状态：</label>
                        <div class="col-sm-8">
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="updateform" >
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">论坛内容：</label>
                            <div class="col-sm-8">
                                <textarea  name="content" class="form-control" id="content" required="" value="" aria-required="true"></textarea>
                            </div>
                        </div>
                </div>
                <div class="modal-footer">
