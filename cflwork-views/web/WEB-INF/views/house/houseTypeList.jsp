    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="panel panel-default">
                ...
                <div class="panel-body form-group" style="margin-bottom:0px;">
                    ...
                    <div class="col-sm-1" style="width: 120px" >
                        <select class="form-control"  id="hotelid_" style="width: 160px;margin-left: -40px" required name="hotelId">
                            <option value="">全部</option>
                        </select>
                    </div>
                    <label class="col-sm-1 control-label" style="width:100px;line-height: 30px;margin-left:10px">房型名称</label>
                    <div class="col-sm-1" style="width: 120px" >
                        <input type="text" class="form-control" id="typeTitle" style="width: 160px;margin-left: -40px" name="title"/>
                    </div>
                    <label class="col-sm-1 control-label" style="margin-left:10px;line-height: 30px;width:100px">房型状态</label>
                    <div class="col-sm-1" style="width: 120px" >
                        <select style="width: 160px;margin-left: -40px" class="form-control" id="hotelStatus" name="isActive">
                            <option value="">全部</option>
            ...
            <div id="toolbar" class="btn-group pull-right" style="margin-right: 20px;">
                <button id="btn_edit" type="button" class="btn btn-default" onclick="statusMany();" style="display: block; border-radius: 0">
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" id="formadd">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">房型类别名称：</label>
                        <div class="col-sm-8">
                            <input  name="title" minlength="2" maxlength="20" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">门市价格：</label>
                        <div class="col-sm-8">
                            <input  name="price" minlength="2"  maxlength="20" type="number" value="" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <form class="form-horizontal" id="updateform" >
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">门市价格：</label>
                        <div class="col-sm-8">
                            <input  name="price" minlength="2" id="price" maxlength="20" type="number" value="" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">说明：</label>
...
<script src="<%=path%>/static/js/pageJs/houseType.js"></script>
</body>
<%--<script>--%>
    <%--$(function () {--%>
        <%--alert("asdflsfa");--%>
