...
//        templates.add("templates/list.jsp.vm");
        templates.add("templates/page.jsp.vm");
//        templates.add("templates/edit.jsp.vm");
//        templates.add("templates/list.js.vm");
        templates.add("templates/js.js.vm");
//        templates.add("templates/edit.js.vm");
